...
- **Comunicación Oficial y Archivos:** Grupo de WhatsApp del equipo
- **Urgencias o bloqueos rápidos:** Mensaje directo por WhatsApp
...
- **Reuniones de Sincronización (Daily Stand-up):** Lunes, miércoles, jueves y sábados en el horario respectivo de clase presencial.
...
- **Prohibido el "Push" directo:** Nadie, bajo ninguna circunstancia, subirá código directamente a `main` o `release` sin pasar por un Pull Request.
...
- **Commits Convencionales:** Todo commit debe seguir el estándar `tipo(alcance): descripción` definido en `docs/02-guia-metodologia/conventional-commits.md`.
...
<!-- Firma: Sebastian Patiño - SebasPatino -->